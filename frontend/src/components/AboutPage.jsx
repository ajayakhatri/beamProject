...
const About=()=>{
  ...
  <ul>
    ...
    <li>
      <a href="#whats-contained-in-each-file">What’s contained in each file?</a>
      <ul>
        <li>
  ...
  <ul>
    <li>
      <p>
        Purpose: The application is designed for modeling and analyzing beam
        structures.
      </p>
    </li>
    <li>
      <p>
        Analysis Method: It employs the finite element method for structural
        analysis. This method involves dividing the beam into several finite
        elements.
      </p>
      <ul>
        <li>
          <p>
            Element Division: The beam is divided into finite elements such that
            their maximum length is set to 0.05 times the total length of the
            beam. This factor of 0.05 can be easily modified in the views.py
            file.
          </p>
        </li>
        <li>
          ...
          <ul>
            <li>Rotation about the normal to the plane of the model (RZ).</li>
  ...
  <p>
    ...
    calculation. Frontend sends data of a beam model to the backend via an HTTP
    request, and there is a Django model for handling the read and write
    operations of beam data in the database. Click{" "}
  ...
  <p>
    ...
    enginnering itself. I googled and found that the existing beam apps on the
    internet were not very fun to use, they need more interactivity. And thus, I
    began my journey by learning React and NumPy.
  </p>
  <h2 id="how-does-this-entire-web-app-work">
    How does this entire web app work?
  </h2>
  <p>
    The flowchart below shows integaration of different components of the web
    app.
  </p>
  <ul>
    <li>
  ...
  <p>
    The Beam Calculator App stands out due to its combination of interactive
    modeling thanks to <strong>React</strong>, a javascript library and analysis
    of modelled beam in <strong>Django backend</strong> by{" "}
  ...
  <ul>
    <li>
      ...
      <ul>
        <li>
          <p>
            Users can create their beam model by dragging and dropping elements
            like loads and supports onto the beam.
          </p>
        </li>
        <li>
          <p>
            The position of loads and supports can be changed by simply dragging
            them along the beam or changed manually.
          </p>
        </li>
        <li>
    ...
    <li>
      <p>
        <strong>Finite Element Analysis with Numpy And Visualization:</strong>{" "}
        Calculations done on backend are depicted as charts (Deformation Curve,
        Shear Force Diagram and Bending Moment Diagram) on Front-end for
    ...
    <li>
      <p>
        <strong>Onboarding guide with intro.js:</strong> Users are provided with
        onboarding guide option via welcome modal as well as a button on top
        section of the web app. The guide gives the tour of the most important
        features of this app so as to make users even more familiar when
        navigating.
      </p>
      <ul>
        <li>
    ...
    <li>
      <p>
        ...
        <strong>work with multiple beams</strong> on a single app independently.
        This opens up possibility of comparing different beams.
      </p>
    </li>
    <li>
      <p>
        <strong>Print:</strong> Users can print the beam with its information
        and charts.
      </p>
    </li>
    <li>
  ...
  <p>
    The project's complexity is evident in its use of multiple technologies and
    the integration of various components. Besides the integration part what I
    found the most complex in the projects were:
  </p>
  <ol>
    <li>
    ...
    <li>
      Logic for arranging data from frontend into NumPy arrays and converting
      distributed load into many finite elements (done in
      backend/api/arrangeData.py).
    </li>
    <li>
      Logic for passing latest state of beam in different React components.
    </li>
  </ol>
  <p>
  ...
  <ul>
    <li>
      ...
      <ol>
        <li>
          <p>
            <strong>NumPy :</strong> It was used to make arrays of load, support
            condition, nodes and beam elements for mathematical operations
            related for Finite Element Analysis. Before feeding the
          </p>
        </li>
        <li>
          <p>
            <strong>djangorestframework :</strong> The api_view decorator was
            used in Django REST framework to define API views. Example :{" "}
            <code>@api_view(["GET"])</code>
          </p>
        </li>
        <li>
          <p>
            <strong>django-cors-headers :</strong> Django CORS Headers is a
            package for handling Cross-Origin Resource Sharing (CORS) in Django
            applications
          </p>
        </li>
      </ol>
    ...
    <li>
      ...
      <ol>
        <li>
          <p>
            <strong>axios:</strong> It provides a simple API for performing HTTP
            requests and processing responses.
          </p>
        </li>
        <li>
          <p>
            <strong>chart.js:</strong> As its name suggest it was used to plot
            charts of <strong>Deformation</strong>, <strong>Shear Force</strong>{" "}
            and <strong>Bending Moment</strong>.
          </p>
        </li>
        <li>
          <p>
            <strong>react-chartjs-2:</strong> A React wrapper for Chart.js.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>interactjs:</strong> A JavaScript library used for drag and
            drop features.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>react-bootstrap:</strong> A library that combines Bootstrap
            with React. It allows developers to use Bootstrap's components and
            styles, but with React's syntax.
          </p>
        </li>
        <li>
          <p>
            <strong>bootstrap:</strong> A popular CSS framework used for
            pre-designed styles and components to build responsive, mobile-first
            web app.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>react-dom:</strong> A package that provides DOM-specific
            methods that can be used at the top level of a web app to enable an
        ...
        <li>
          <p>
            ...
            concurrent tasks. In this case, it was used to run both react and
            django using a single command <code>npm run start</code> in script
            of <strong>package.json</strong>.
          </p>
          <pre>
            <code className="lang-json">
              ...
              <span className="hljs-string">"concurrently \"</span>cd ../backend
  ...
  <h2 id="whats-contained-in-each-file">What’s contained in each file?</h2>
  <p>
    Files in both back-end and front-end along with their information are given
    below:
  </p>
  ...
  <pre>
    <code>
      ...
      <span className="hljs-keyword">from</span> frontend into NumPy arrays
      ...
      {"   "}# Cached Python files{"\n"}│{"   "}├── __init__.py{"    "}#
      Initialization script for the <span className="hljs-string">'beam'</span>{" "}
  ...
  <pre>
    <code>
      ...
      {"\n"}│{"   "}│{"   "}├── DndStage1.jsx{"         "}# Handles dropping{" "}
      <span className="hljs-keyword">of</span> elements on beam{"\n"}│{"   "}│
      {"   "}├── DndStage2.jsx{"         "}# Handles dragging{" "}
      <span className="hljs-keyword">of</span> elements on beam{"\n"}│{"   "}│
      {"   "}├── FixedEnds.jsx{"         "}# Toggle for fixed ends supports
      {"\n"}│{"   "}│{"   "}├── Img.jsx{"               "}# Contains svg images{" "}
      <span className="hljs-keyword">of</span> elements{"\n"}│{"   "}│{"   "}├──
      ...
      {"\n"}│{"   "}│{"   "}├── OnBoarding.jsx{"        "}# Contains Logic for
      onboarding tour{"\n"}│{"   "}│{"   "}├── PositionDimension.jsx # Changes
      position dimensions when there is any change{"\n"}│{"   "}│{"   "}├──
      Print.jsx{"             "}# Prints the beam and charts{"\n"}│{"   "}│
      {"   "}├── SaveBeam.jsx{"          "}# Sends a beam to backend to be
      saved.{"\n"}│{"   "}│{"   "}├── Switch.jsx{"            "}# Toggles for
      length, load and border display{"\n"}│{"   "}│{"   "}├── ToolBar.jsx
      {"           "}# Contains toolbox <span className="hljs-keyword">of</span>{" "}
      draggable elements{"\n"}│{"   "}│{"   "}├── utility.js{"            "}#
      Contains fuction for random colour and hexToRGBA{"\n"}│{"   "}│{"   "}└──
      WelcomeModal.jsx{"      "}# Lunches Welcome Modal{"\n"}│{"   "}├──
      dataFlow/{"\n"}│{"   "}│{"   "}├── axios.jsx{"             "}# Input for
      baseUrl <span className="hljs-keyword">of</span> backend server{"\n"}│
  ...
  <ul>
    ...
    <li>
      <p>
        ...
        update baseURL in axios.jsx file:
      </p>
      <pre>
        <code>
          {" "}
    ...
    <li>
      <p>
        The frontend and backend are separated, that means the user can change
        method of analysis in backend to any methods while using the beautiful
        frontend as it is.
      </p>
    </li>
    <li>
  ...
  <p>
    <a href="https://linkedin.com/in/ajaya-khatri-7b9715254" target="blank">
      <img
        align="center"
...
export const AboutPage=({showAboutPage,setShowAboutPage})=> {
  ...
  return ( 
    <>
      <Modal show={showAboutPage} fullscreen={true} onHide={() => setShowAboutPage(false)}>
