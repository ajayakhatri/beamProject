...
export function DropableNew(props) {
    const { beamID, changeToolValue, beamLength, style, id, deleteTool, dlspan, changeDLSpan, toolType, load } = props
    ...
    return (
        <div ref={toolsRef} id={id} key={id} style={combinedStyle} className={`SlidingTools_Beam_${beamID}`} >
            ...
            {
                toolType == "distributedLoad" && (<><input
                    type="number"
                    inputMode="numeric"
                    min={0.1}
                    ...
                    value={dlSpanValue}
                    id={`setdlspan${id}`}
                    style={{ width: "60px", textAlign: "center", height: "22px", marginLeft: `${getToolWidth() + 8}px` }}
            ...
            <div style={{ position: "absolute", marginTop: "32px", marginLeft: "-6px", display: "flex", justifyContent: "center", flexDirection: "column", gap: "2px" }}>
                <input
                    ...
                    value={inputValue}
                    id={`setLength${id}`}
                    style={{ width: "60px", textAlign: "center", marginLeft: toolType === "distributedLoad" && (`${getToolWidth() + 8}px`) }}
